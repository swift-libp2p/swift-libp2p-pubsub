...
// Source: Sources/LibP2PPubSub/Protobufs/RPC2.proto
//
...
extension RPC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}subscriptions\0\u{1}msgs\0\u{1}control\0")
...
extension RPC.Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}from\0\u{1}data\0\u{1}seqno\0\u{1}topicIDs\0\u{1}signature\0\u{1}key\0")
